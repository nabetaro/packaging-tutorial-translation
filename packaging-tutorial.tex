...
%(numeric values).
\date{\footnotesize version 0.8 -- 2013-03-02} % DATE - use debian/rules update-version-date
...
\begin{itemize}
	...
	\item Use \texttt{debi} to install it and test it.
		\hbr
	\item Fill in \texttt{debian/control} using \url{http://www.debian.org/doc/debian-policy/ch-controlfields}
		\hbr
